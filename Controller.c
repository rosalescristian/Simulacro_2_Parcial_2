...
void controller_PrintEmployee(void* this)
{
    ...
    char nombreStruct[50];
    char dniStruct[8];
    //eFecha fechaPresentacion;
    char fechaPresentacionStruct[10];
    char temaPresentacionStruct[30];
	...
	if(this != NULL)
	{
		...
		employee_getId(this,&idStruct);
		employee_getAnio(this,&anioNacimientoStruct);
		employee_getNombre(this,nombreStruct);
		employee_getDni(this,dniStruct);
		employee_getFechaPresentacion(this,fechaPresentacionStruct);
		employee_getTemaPresentacion(this,temaPresentacionStruct);
		employee_getPuntajePrimeraRonda(this,&puntajePrimeraRondaStruct);
        //printf("\t%4d\t", idStruct);
        //printf("\t%d\t", anioNacimientoStruct);
        //printf("\t%-30s", nombreStruct);
        //printf("%s\n", dniStruct);
        //printf("%s ", fechaPresentacionStruct);
        //printf("%s ", temaPresentacionStruct);
        //printf("%d ", puntajePrimeraRondaStruct);
        //printf("\t%4d\t\t%4d\t\t%-30s%-8s\t%-10s\t%s\t%4d\n",idStruct,anioNacimientoStruct,nombreStruct,dniStruct,fechaPresentacionStruct,temaPresentacionStruct,puntajePrimeraRondaStruct);
        //printf("%s\n", dniStruct);
    }
