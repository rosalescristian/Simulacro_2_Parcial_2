...
int employee_getDni(Employee* this,char* cadena);
int employee_getAnio(Employee* this,int *number);
int employee_getFechaPresentacion(Employee* this,char* cadena);
int employee_getTemaPresentacion(Employee* this,char* cadena);
